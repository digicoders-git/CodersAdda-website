...
import { 
  Smartphone, Download, Play, Apple, Globe, BookOpen,
  Briefcase, Video, CheckCircle, Sparkles, Zap, Clock,
  Users, ArrowRight, Shield, Wifi, TabletSmartphone,
  TrendingUp, Star, SmartphoneNfc
} from 'lucide-react';
    ...
    <div className="w-full min-h-screen overflow-x-hidden" style={{ backgroundColor: colors.white }}>
          ...
          <div className="flex-1 relative w-full lg:max-w-lg">
            <div className="relative" style={{
              ...
              <div className="relative mx-auto max-w-lg">
                ...
                <div className="absolute -top-4 -right-4 w-16 h-16 rounded-2xl flex items-center justify-center animate-float"
                  style={{ 
                ...
                <div className="absolute -bottom-4 -left-4 w-16 h-16 rounded-2xl flex items-center justify-center animate-float"
                  style={{ 
                    backgroundColor: colors.white,
                    boxShadow: '0 10px 30px rgba(0,0,0,0.1)',
                    animationDelay: '0.8s'
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="group p-8 rounded-3xl transition-all duration-500 hover:scale-105 hover:shadow-2xl"
              style={{ 
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-16">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="flex border rounded-2xl p-1 mb-8"
            ...
            <button
              ...
              className={`flex-1 py-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 ${
                activePlatform === 'android' ? 'scale-105' : ''
              }`}
              style={{ 
                backgroundColor: activePlatform === 'android' ? colors.white : 'transparent',
                color: activePlatform === 'android' ? colors.textPrimary : colors.textSecondary,
                boxShadow: activePlatform === 'android' ? '0 4px 20px rgba(0,0,0,0.1)' : 'none'
              }}
            >
              <Play size={24} style={{ color: activePlatform === 'android' ? colors.primary : colors.textSecondary }} />
              Android
            </button>
            <button
              onClick={() => setActivePlatform('ios')}
              className={`flex-1 py-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-3 ${
                activePlatform === 'ios' ? 'scale-105' : ''
              }`}
              style={{ 
                backgroundColor: activePlatform === 'ios' ? colors.white : 'transparent',
                color: activePlatform === 'ios' ? colors.textPrimary : colors.textSecondary,
                boxShadow: activePlatform === 'ios' ? '0 4px 20px rgba(0,0,0,0.1)' : 'none'
              }}
            >
              <Apple size={24} style={{ color: activePlatform === 'ios' ? colors.primary : colors.textSecondary }} />
              iOS
            </button>
          </div>

          {/* Platform Details */}
          <div className={`transition-all duration-500 ${activePlatform === 'android' ? 'opacity-100' : 'opacity-0 hidden'}`}>
          ...
          <div className={`transition-all duration-500 ${activePlatform === 'ios' ? 'opacity-100' : 'opacity-0 hidden'}`}>
            <div className="p-8 rounded-3xl text-center"
              style={{ 
                background: `linear-gradient(135deg, ${colors.primary}10, ${colors.secondary}10)`,
                border: `1px solid ${colors.border}20`
